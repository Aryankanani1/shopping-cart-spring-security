...
public class ImageController {
    ...
    @PostMapping("/upload")
    public ResponseEntity<ApiResponse> saveImages(@RequestParam List<MultipartFile> fileList,@RequestParam Long productId){

            try {
                List<ImageDto> imageDtos = imageServiceInterface.saveImages(fileList, productId);
